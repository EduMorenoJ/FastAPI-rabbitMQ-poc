...
RABBIT_HOST: str = os.environ["RABBIT_HOST"]
RABBIT_PORT: int = int(os.environ["RABBIT_PORT"])
RABBIT_USER: str = os.environ["RABBIT_USERNAME"]
...
async def get_async_client(
    ...
    return await connect_robust(f"amqp://{username}:{password}@{host}:{port}/", loop=loop)
